This is a program designed to combine OpenCV tracking with breath sensing, utilizing a rubber cord stretch sensor.
This was created by Merritt Lum, Nika Styk, Len Wang & Purui Shi.


Various code attributions can be found within the code itself.


Arduino code is designed to be run with a Adafruit Playground Express, though can be adapted to other boards with little effort.
